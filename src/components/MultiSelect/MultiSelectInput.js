...
export default function MultiSelectInput({ selectedOptions, setSelectedOptions, toggleSelection,
  changeDropDownOpenedState, isOpen, text, handleTextChange }) {
  ...
  return (
    <div className="InputWrapper">
      ...
      {selectedOptions?.length > 0 &&
        <div className="ArrowWrapper" onClick={handleClearClicked}>
          <img src={xImage} className="arrow-static" alt="Clear All" />
        </div>
      }
